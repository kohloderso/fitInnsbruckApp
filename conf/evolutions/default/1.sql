...
alter table facility add constraint fk_facility_openingHours_1 foreign key (hoursID) references opening_hours (hours_id);
create index ix_facility_openingHours_1 on facility (hoursID);
alter table facility add constraint fk_facility_prices_2 foreign key (priceID) references pricing (price_id);
create index ix_facility_prices_2 on facility (priceID);
alter table open_period add constraint fk_open_period_open_hours_day_3 foreign key (open_hours_day_day_id) references open_hours_day (day_id);
create index ix_open_period_open_hours_day_3 on open_period (open_hours_day_day_id);
alter table open_period add constraint fk_open_period_openingHours_4 foreign key (opening_hours_hours_id) references opening_hours (hours_id);
create index ix_open_period_openingHours_4 on open_period (opening_hours_hours_id);
alter table opening_hours add constraint fk_opening_hours_monday_5 foreign key (mondayID) references open_hours_day (day_id);
create index ix_opening_hours_monday_5 on opening_hours (mondayID);
alter table opening_hours add constraint fk_opening_hours_tuesday_6 foreign key (tuesdayID) references open_hours_day (day_id);
create index ix_opening_hours_tuesday_6 on opening_hours (tuesdayID);
alter table opening_hours add constraint fk_opening_hours_wednesday_7 foreign key (wednesdayID) references open_hours_day (day_id);
create index ix_opening_hours_wednesday_7 on opening_hours (wednesdayID);
alter table opening_hours add constraint fk_opening_hours_thursday_8 foreign key (thursdayID) references open_hours_day (day_id);
create index ix_opening_hours_thursday_8 on opening_hours (thursdayID);
alter table opening_hours add constraint fk_opening_hours_friday_9 foreign key (fridayID) references open_hours_day (day_id);
create index ix_opening_hours_friday_9 on opening_hours (fridayID);
alter table opening_hours add constraint fk_opening_hours_saturday_10 foreign key (saturdayID) references open_hours_day (day_id);
create index ix_opening_hours_saturday_10 on opening_hours (saturdayID);
alter table opening_hours add constraint fk_opening_hours_sunday_11 foreign key (sundayID) references open_hours_day (day_id);
